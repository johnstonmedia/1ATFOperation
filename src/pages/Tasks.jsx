...
function Inner() {
  ...
  // Only tasks RHQ has DISTRIBUTED to the user's own company appear here.
  const tasks = state.tasks.filter((t) => t.distributed && t.audience === user.company)
          ...
          <div key={t.id} className="panel panel-pad row between center wrap" style={{ gap: 12 }}>
            <div>
              ...
              <div className="mono dim" style={{ fontSize: 11 }}>
                {t.questions?.length || 0} items · {t.audience}-COY
