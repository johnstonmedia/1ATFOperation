...
export default function OperationsCentre() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      {/* Side rail */}
      <aside style={{ width: 250, borderRight: '1px solid var(--accent)', background: 'var(--panel-solid)',
        padding: 18, display: 'flex', flexDirection: 'column', gap: 6, position: 'sticky', top: 0, height: '100vh' }}>
      ...
      {/* Work area */}
      <div className="grow" style={{ padding: '28px 32px', maxWidth: 1100 }}>
